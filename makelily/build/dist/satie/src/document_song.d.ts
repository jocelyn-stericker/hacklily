...
export declare type PrivatePatches = {
    isPatches: boolean;
};
...
export declare function specIsRaw(spec: IPatchSpec): spec is {
    raw: IAny[];
};
export declare function specIsDocBuilder(spec: IPatchSpec): spec is {
    documentBuilder: (documentBuilder: DocumentBuilder) => DocumentBuilder;
};
export declare function specIsPartBuilder(spec: IPatchSpec): spec is {
    measure: number;
    part: string;
    partBuilder: (partBuilder: PartBuilder) => PartBuilder;
};
...
export declare type ISongClass = React.ComponentClass<IProps> & {
    new (p: IProps): ISong;
};
