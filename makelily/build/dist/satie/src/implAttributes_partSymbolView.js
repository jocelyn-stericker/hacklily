...
var PartSymbolView = /** @class */ (function (_super) {
    ...
    PartSymbolView.prototype.render = function () {
        ...
        return (React.createElement("g", null,
            sym,
            React.createElement(private_views_line_1.default, { key: "line", stroke: "#000000", strokeWidth: defaults.thinBarlineThickness * 10, x1: this.props.spec.defaultX, x2: this.props.spec.defaultX, y1: bottom - height, y2: bottom })));
    };
    PartSymbolView.prototype.getSymbol = function () {
        ...
        switch (spec.type) {
            case musicxml_interfaces_1.PartSymbolType.Brace:
                return (React.createElement(private_views_glyph_1.default, { fill: "#000000", glyphName: "brace", key: "partSymbolMain", transform: "scale(" +
                        BRACE_H_SCALE +
                        "," +
                        s +
                        ")" +
            ...
            case musicxml_interfaces_1.PartSymbolType.Square: // TODO: Not implemented
                return [
                    React.createElement(private_views_line_1.default, { key: "partSymbolMain", stroke: "#000000", strokeWidth: defaults.bracketThickness * 10, x1: x + 4 + 2.5, x2: x + 4 + 2.5, y1: bottom - height - 2 - 3, y2: bottom + 2 + 3 }),
                    React.createElement(private_views_glyph_1.default, { fill: "#000000", glyphName: "bracketTop", key: "bracketTop", x: x + 4, y: this.context.systemTop - 2 }),
                    React.createElement(private_views_glyph_1.default, { fill: "#000000", glyphName: "bracketBottom", key: "bracketBottom", x: x + 4, y: this.context.systemBottom + 2 }),
                ];
