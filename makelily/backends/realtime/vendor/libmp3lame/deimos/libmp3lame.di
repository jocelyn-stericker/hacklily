module deimos.libmp3lame;

extern(C) {
    alias extern(C) void function(const char* format, ...) lame_report_function;
    ...
    alias lame_global_struct = void;
    alias lame_global_flags = lame_global_struct;
    alias lame_t = lame_global_flags*;
    ...
    int lame_set_num_samples(lame_global_flags *, ulong);
    ulong lame_get_num_samples(const lame_global_flags *);
    ...
    */
    ...
    float lame_get_scale_left(const lame_global_flags *);
    ...
    */
    ...
    float lame_get_scale_right(const lame_global_flags *);
    ...
    */
    ...
    int lame_get_findReplayGain(const lame_global_flags *);
    ...
    int lame_get_decode_on_the_fly(const lame_global_flags *);
    
    /* counters for gapless encoding */
    int lame_set_nogap_total(lame_global_flags*, int);
    int lame_get_nogap_total(const lame_global_flags*);
    
    int lame_set_nogap_currentindex(lame_global_flags* , int);
    int lame_get_nogap_currentindex(const lame_global_flags*);
    ...
    int lame_set_quant_comp(lame_global_flags *, int);
    int lame_get_quant_comp(const lame_global_flags *);
    int lame_set_quant_comp_short(lame_global_flags *, int);
    int lame_get_quant_comp_short(const lame_global_flags *);
    
    int lame_set_experimentalX(lame_global_flags *, int); /* compatibility*/
    ...
    float lame_get_msfix(const lame_global_flags *);
    ...
    float lame_get_VBR_quality(const lame_global_flags *);
    ...
    */
    ...
    int lame_set_athaa_type( lame_global_flags *, int);
    ...
    */
    ...
    int lame_get_RadioGain(const lame_global_flags *);
    
    /* AudiophileGain value. Multipled by 10 and rounded to the nearest. */
    int lame_get_AudiophileGain(const lame_global_flags *);
    
    /* the peak sample */
    float lame_get_PeakSample(const lame_global_flags *);
    
    /* Gain change required for preventing clipping. The value is correct only if
       peak sample searching was enabled. If negative then the waveform
       already does not clip. The value is multiplied by 10 and rounded up. */
    int lame_get_noclipGainChange(const lame_global_flags *);
    
    /* user-specified scale factor required for preventing clipping. Value is
       correct only if peak sample searching was enabled and no user-specified
       scaling was performed. If negative then either the waveform already does
       not clip or the value cannot be determined */
    float lame_get_noclipScale(const lame_global_flags *);
    ...
    */
    int lame_encode_buffer (
            ...
            const short*    buffer_l,   /* PCM data for left channel     */
            const short*    buffer_r,   /* PCM data for right channel    */
            const int           nsamples,      /* number of samples per channel */
            ubyte*      mp3buf,        /* pointer to encoded MP3 stream */
    ...
    int lame_encode_buffer_interleaved(
            ...
            short*           pcm,         /* PCM data for left and right
                                                  channel, interleaved          */
    ...
    size_t lame_get_lametag_frame(
            const lame_global_flags *, ubyte* buffer, size_t size);
    ...
    enum hip_global_struct;
    alias hip_global_flags = hip_global_struct;
    alias hip_t = hip_global_flags*;
    ...
    struct mp3data_struct {
      ...
      ulong nsamp; /* number of samples in mp3 file.                 */
    ...
    int hip_decode_headers( hip_t           gfp
                                , ubyte*  mp3buf
                                , size_t          len
                                , short*          pcm_l
                                , short*          pcm_r
    ...
    int hip_decode1_headers( hip_t           gfp
                                 , ubyte*  mp3buf
                                 , size_t          len
                                 , short*          pcm_l
                                 , short*          pcm_r
    ...
    int hip_decode1_headersB( hip_t gfp
                                  , ubyte*   mp3buf
                                  , size_t           len
                                  , short*           pcm_l
                                  , short*           pcm_r
    ...
    alias extern(C) void function(int, const ubyte*, void*) handler;
     ...
     */
    size_t lame_get_id3v1_tag(lame_t gfp, char* buffer, size_t size);
     ...
     */
    size_t lame_get_id3v2_tag(lame_t gfp, char* buffer, size_t size);
     ...
     */
    void lame_set_write_id3tag_automatic(lame_global_flags * gfp, int);
    int lame_get_write_id3tag_automatic(lame_global_flags* gfp);
    
    /* experimental */
    int id3tag_set_textinfo_latin1(lame_t gfp, char *id, char *text);
    
    /* experimental */
    int id3tag_set_comment_latin1(lame_t gfp, char *lang, char *desc, char *text);
    
    /* experimental */
    int id3tag_set_fieldvalue_utf16(lame_t gfp, ushort *fieldvalue);
    
    /* experimental */
    int id3tag_set_textinfo_utf16(lame_t gfp, char *id, ushort *text);
    
    /* experimental */
    int id3tag_set_comment_utf16(lame_t gfp, char *lang, ushort *desc, ushort *text);
    ...
    ***********************************************************************/
    ...
    extern const int[3][16]     bitrate_table;
    extern const int[3][ 4]     samplerate_table;
    ...
    enum LAME_MAXALBUMART =  (128 * 1024);
    
    /* maximum size of mp3buffer needed if you encode at most 1152 samples for
       each call to lame_encode_buffer.  see lame_encode_buffer() below  
       (LAME_MAXMP3BUFFER is now obsolete)  */
    enum LAME_MAXMP3BUFFER = (16384 + LAME_MAXALBUMART);
    ...
    */
    void lame_mp3_tags_fid(lame_global_flags *, void* fid);
}
