...
int mpg123_read(mpg123_handle *mh, char *outmemory, size_t outmemsize, size_t *done);
...
int mpg123_feed(mpg123_handle *mh, const(char) *in_, size_t size);
 ...
 */
int mpg123_decode(mpg123_handle *mh, const(char) *inmemory, size_t inmemsize, char *outmemory, size_t outmemsize, size_t *done);
 ...
 */
int mpg123_decode_frame(mpg123_handle *mh, long *num, char **audio, size_t *bytes);
 ...
 *  \param bytes number of output bytes ready in the buffer
 */
int mpg123_framebyframe_decode(mpg123_handle *mh, long *num, char **audio, size_t *bytes);
 ...
 */
int mpg123_framedata(mpg123_handle *mh, ulong *header, char **bodydata, size_t *bodybytes);
...
long mpg123_framepos(mpg123_handle *mh);
...
long mpg123_tell_stream(mpg123_handle *mh);
 ...
 *  \return The resulting offset >= 0 or error/message code */
long mpg123_feedseek(mpg123_handle *mh, long sampleoff, int whence, long *input_offset);

/** Seek to a desired MPEG frame index.
 *  Set whence to SEEK_SET, SEEK_CUR or SEEK_END.
 *  \return The resulting offset >= 0 or error/message code */
long mpg123_seek_frame(mpg123_handle *mh, long frameoff, int whence);
...
int mpg123_index(mpg123_handle *mh, long **offsets, long *step, size_t *fill);
 ...
 *  \param step    one index byte offset advances this many MPEG frames
 *  \param fill    number of recorded index offsets; size of the array */ 
int mpg123_set_index(mpg123_handle *mh, long *offsets, long step, size_t fill);
...
int mpg123_position( mpg123_handle *mh, long frame_offset, long buffered_bytes, long *current_frame, long *frames_left, double *current_seconds, double *seconds_left);
...
/** Override the value for file size in bytes.
  ...
  * \return MPG123_OK or MPG123_ERR */
int mpg123_set_filesize(mpg123_handle *mh, long size);
 ...
 */
int mpg123_getstate(mpg123_handle *mh, mpg123_state key, long *val, double *fval);
...
enum mpg123_text_encoding mpg123_enc_from_id3(char id3_enc_byte);
 ...
 */
int mpg123_store_utf8(mpg123_string *sb, mpg123_text_encoding enc, const(char) *source, size_t source_size);
...
struct mpg123_id3v2
{
	char version_; /**< 3 or 4 for ID3v2.3 or ID3v2.4. */
...
/** Opaque structure for the libmpg123 decoder parameters. */
alias mpg123_pars_struct   mpg123_pars;
...
int mpg123_replace_buffer(mpg123_handle *mh, char *data, size_t size);
...
alias r_read = long function(int, void *, size_t);
alias r_lseek = long function(int, long, int);
...
//int mpg123_replace_reader_handle(mpg123_handle *mh, long (*r_read) (void *, void *, size_t), long (*r_lseek)(void *, long, int), void (*cleanup)(void*));
}
