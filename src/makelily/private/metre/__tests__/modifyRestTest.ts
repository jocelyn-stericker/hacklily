...
import {shortenRest} from "../modifyRest";
...
describe("modifyRest", function() {
    ...
    it("returns valid patches", function() {
        ...
        let p = shortenRest(voice, doc, attributes.times[0], 0, 1, 1).patches;
    ...
    it("handles the middle of the bar", function() {
        ...
        let p = shortenRest(voice, doc, attributes.times[0], 1, 3, 2).patches;
