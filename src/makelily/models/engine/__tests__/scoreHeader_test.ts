...
describe("[engine/scoreHeader.ts]", function() {
    ...
    it("can correctly modify metadata", function() {
        var mxmljson = MusicXML.parse(headerTest);
        var scoreHeader = new ScoreHeader(mxmljson);
