      ...
      <span>
        ...
        <table style={{ borderWidth: 1, borderColor: 'black' }}>
          <tr>
            ...
            <td>
              Select note duration (1 = 32<sup>nd</sup> note, 7 = whole note)
              for the next note you enter.
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              Toggle the number of dots to add to the
              next note you enter.
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              Insert a note where the cursor is.
              Creates a new bar if cursor is at the
              end of a bar.
            </td>
          </tr>
          <tr>
            ...
            <td>
              Insert a rest where the cursor is.
              Creates a new bar if cursor is at the
              end of a bar.
            </td>
          </tr>
          <tr>
            ...
            <td>
              Add a note to the previous note or chord.
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              Bump the previous note up an octave.
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              Bump the previous note down an octave.
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              Move the cursor back a note or rest.
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              Move the cursor forward a note or rest.
            </td>
          </tr>
          <tr>
            <td>
  ...
  private renderMIDI(): JSX.Element {
    return (
      <span>
        ...
        <p>
          This feature is coming soon&hellip;
        </p>
      </span>
    );
    /*<p>
  ...
  private renderMouse(): JSX.Element {
    return (
      <span>
        ...
        <p>
          <strong>To insert notes,</strong>{' '}
          click on the desired duration of music in the
          toolbar (e.g., quarter note or half note).

          Then, click on any desired modifiers to that note
          (e.g., dots, tuplets, or accidentals).

          Finally, click on the staff where you want the note.
        </p>
        <p>
          <strong>To insert chords,</strong>{' '}
          pick a note or chord to add a note to, and click above
          or below it to add that note.
        </p>
        <p>
          <strong>To insert rests,</strong>{' '}
          click the rest icon beside the sharp icon on the toolbar,
          then insert it as you would a note.
        </p>
        <p>
          <strong>To add another bar,</strong>{' '}
          click the "Add Bar" option on the toolbar.
        </p>
        <p>
          <strong>Tip:</strong> you can undo and redo any changes using the
          undo and redo buttons, so don't be afraid to explore.
        </p>
      </span>
    );
  }
    ...
    return (
      <span>
        ...
        <p>
          ...
          single note. Relative octave entry, in contrast, specifies each octave in relation to the
          last note: changing one note’s octave will affect all of the following notes.
        </p>
        <p>
  ...
  private renderWhyNotEdit(): JSX.Element {
    return (
      <span>
        ...
        <p>
          Use this tool to generate LilyPond markup for one or more bars
          of notes in single voice and staff. You can enter notes using
          a mouse, computer keyboard, or MIDI keyboard. This tool does
          not support editing existing LilyPond markup.
        </p>
        <p>
          This tool can insert notes with their corresponding dynamics and
          markings. Keep an eye out for other tools that help
          generate LilyPond markup for other elements of sheet music!
        </p>
        <p>
