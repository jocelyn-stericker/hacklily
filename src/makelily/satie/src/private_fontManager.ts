...
const State = {
  fonts: {} as { [font: string]: Font },
  cbs: [] as ((err?: Error) => void)[],
  remaining: 0,
  err: null as Error,
...
function resolvePDKey(
  ...
  return (
    name + "_" + text + "_" + x + "_" + y + "_" + fontSize + "_" + (style || "")
  );
}
