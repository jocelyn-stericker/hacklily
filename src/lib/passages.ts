...
export type Passage =
  ...
  | (PassageBase & { kind: 'passage'; segments: readonly string[] })
  | (PassageBase & {
      kind: 'sentenceLists'
...
export const passages = [
  {
    ...
    sourceUrl:
      'https://www.dialectsarchive.com/wp-content/uploads/2015/11/The-Rainbow-Passage.pdf',
    attribution:
  ...
  },
  {
    ...
    source:
      'Columbia University (H. Schulzrinne) — transcription of IEEE lists',
  ...
  },
  {
    ...
    segments: [
      ...
      'Well, he is nearly ninety-three years old; he dresses himself in an ancient black frock coat, usually minus several buttons; yet he still thinks as swiftly as ever.',
      ...
      'Twice each day he plays skilfully and with zest upon our small organ.',
  ...
  },
  {
    ...
    segments: [
      ...
      'Whenever the other rats asked him if he would like to come out hunting with them, he would answer in a hoarse voice, "I don\'t know."',
      'And when they said, "Would you rather stay inside?" he wouldn\'t say yes, or no either.',
      ...
      'You have no more mind of your own than a greasy old blade of grass!"',
      ...
      'It was a very dreary old place.',
      'The roof let the rain come washing in, the beams and rafters had all rotted through, so that the whole thing was quite unsafe.',
      'At last one of the joists gave way, and the beams fell with one edge on the floor.',
      "The walls shook, and the cupola fell off, and all the rats' hair stood on end with fear and horror.",
      '"This won\'t do," said their leader.',
      '"We can\'t stay cooped up here any longer."',
      'So they sent out scouts to search for a new home.',
      ...
      '"Why, the idea of it!',
      "You don't think it's safe here any more, do you?\"",
      '"I\'m not certain," said Arthur undaunted.',
      '"The roof may not fall down yet."',
      '"Well," said the old rat, "we can\'t wait for you to join us."',
      'Then he turned to the others and shouted, "Right about face!',
      'March!" and the long line marched out of the barn while the young rat watched them.',
      '"I think I\'ll go tomorrow," he said to himself, "but then again, perhaps I won\'t - it\'s so nice and snug here.',
      'I guess I\'ll go back to my hole under the log for a while just to make up my mind."',
      'But during the night there was a big crash.',
      'Down came beams, rafters, joists - the whole business.',
      'Next morning - it was a foggy day - some men came to look over the damage.',
      'It seemed odd that the old building was not haunted by rats.',
      'But at last one of them happened to move a board, and he caught sight of a young rat, quite dead, half in and half out of his hole.',
