        ...
        <div className="flex flex-col gap-5 py-2">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Select
              ...
              onValueChange={(val) => {
                if (
                  val === (settings.persistentMic ? 'persistent' : 'on-demand')
                )
                  return
                void updateSettings({
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="on-demand">While recording only</SelectItem>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <p className="text-xs text-muted-foreground">
              &ldquo;Prefer minimal processing&rdquo; tells the browser to skip
