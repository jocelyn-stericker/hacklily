...
export function serializeScore(score: ScoreTimewise, parttime: boolean = false): string {
...
(function init() {
    ...
    if (isIE) {
        ...
        let timepartXSLDoc = (new DOMParser).parseFromString(timepartXSLBuffer, "text/xml");
        ...
        timewiseToPartwise = function(str: string) {
            let dom: Document = (new DOMParser).parseFromString(str, "text/xml");
            return new XMLSerializer().serializeToString(timepartXSLProcessor.transformToDocument(dom).documentElement);
        }
    }
}());
...
function xmlToMeasure(node: Node) {
    let ret: Measure = <any> {};
...
function getStartStop(node: Node, fallbackVal?: StartStop) {
    "use strict"
    let s = (node.nodeType === node.ATTRIBUTE_NODE ? (<Attr>node).value : node.textContent).trim();
...
function xmlToPosition(node: Node) {
...
function xmlToPlacement(node: Node) {
...
function xmlToDirectiveEntity(node: Node) {
...
function xmlToBezier(node: Node) {
    let ret: Bezier = <any> {};
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
    }
...
function xmlToOrientation(node: Node) {
...
function getTopMiddleBottomBaseline(node: Node, fallbackVal?: TopMiddleBottomBaseline) {
    "use strict"
    let s = (node.nodeType === node.ATTRIBUTE_NODE ? (<Attr>node).value : node.textContent).trim();
    if (s === "" && fallbackVal !== null && fallbackVal !== undefined) {
        return fallbackVal;
...
function getSolidDashedDottedWavy(node: Node, fallbackVal?: SolidDashedDottedWavy) {
    "use strict"
    let s = (node.nodeType === node.ATTRIBUTE_NODE ? (<Attr>node).value : node.textContent).trim();
    if (s === "" && fallbackVal !== null && fallbackVal !== undefined) {
        return fallbackVal;
...
function xmlToTextDecoration(node: Node) {
...
function xmlToJustify(node: Node) {
    let ret: Justify = <any> {};
    let foundJustify = false;
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
...
function xmlToHalign(node: Node) {
    let ret: Halign = <any> {};
    ...
    for (let i = 0; i < node.attributes.length; ++i) {
        let ch2 = node.attributes[i];
        if (ch2.name === "halign") {
            let dataHalign = getLeftCenterRight(ch2, ((<any>ret).justify || LeftCenterRight.Left));
...
function xmlToValign(node: Node) {
    let ret: Valign = <any> {};
...
function xmlToValignImage(node: Node) {
...
function xmlToLetterSpacing(node: Node) {
...
function xmlToLineHeight(node: Node) {
...
function xmlToTextDirection(node: Node) {
...
function xmlToTextRotation(node: Node) {
...
function xmlToEnclosure(node: Node) {
...
function xmlToLineShape(node: Node) {
...
function xmlToDashedFormatting(node: Node) {
...
function xmlToPrintObject(node: Node) {
...
function xmlToPrintSpacing(node: Node) {
...
function xmlToLevelDisplay(node: Node) {
...
function xmlToTrillSound(node: Node) {
...
function xmlToTimeOnly(node: Node) {
...
function xmlToDocumentAttributes(node: Node) {
...
function xmlToFootnote(node: Node) {
...
function xmlToFermata(node: Node) {
    let ret: Fermata = <any> {};
...
function xmlToWavyLine(node: Node) {
...
function xmlToString(node: Node) {
    let ret: String = <any> {};
    let foundFontWeight = false;
    let foundFontStyle = false;
    let foundColor = false;
...
function xmlToDisplayText(node: Node) {
...
function xmlToAccidentalText(node: Node) {
...
function xmlToMidiDevice(node: Node) {
...
function xmlToMidiInstrument(node: Node) {
...
function xmlToOtherPlay(node: Node) {
    let ret: OtherPlay = {
        data: "",
        type: ""
    };
...
function xmlToScaling(node: Node) {
    let ret: Scaling = {
        tenths: null,
        millimeters: null
    };
...
function xmlToPageMargins(node: Node) {
...
function xmlToPageLayout(node: Node) {
...
function xmlToSystemLayout(node: Node) {
...
function xmlToSystemMargins(node: Node) {
...
function xmlToSystemDividers(node: Node) {
...
function xmlToStaffLayout(node: Node) {
...
function xmlToMeasureLayout(node: Node) {
...
function xmlToLineWidth(node: Node) {
...
function xmlToNoteSize(node: Node) {
...
function xmlToDistance(node: Node) {
...
function xmlToAppearance(node: Node) {
...
function xmlToCreator(node: Node) {
    let ret: Creator = <any> {};
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
    }
...
function xmlToRights(node: Node) {
    let ret: Rights = <any> {};
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
    }
...
function xmlToEncoder(node: Node) {
    let ret: Encoder = <any> {};
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
    }
...
function xmlToRelation(node: Node) {
...
function xmlToMiscellaneousField(node: Node) {
...
function xmlToMiscellaneous(node: Node) {
...
function xmlToEncoding(node: Node) {
...
function xmlToTimeSeparator(node: Node) {
...
function xmlToTimeSymbol(node: Node) {
...
function xmlToCancel(node: Node) {
    let ret: Cancel = <any> {};
...
function xmlToKeyOctave(node: Node) {
...
function xmlToInterchangeable(node: Node) {
...
function xmlToStaffTuning(node: Node) {
...
function xmlToStaffDetails(node: Node) {
...
function xmlToTranspose(node: Node) {
...
function xmlToDirective(node: Node) {
...
function xmlToMultipleRest(node: Node) {
...
function xmlToMeasureRepeat(node: Node) {
...
function xmlToBeatRepeat(node: Node) {
...
function xmlToMeasureStyle(node: Node) {
...
function xmlToAttributes(node: Node) {
...
function xmlToFullNote(node: Node) {
...
function xmlToInstrument(node: Node) {
...
function xmlToAccidental(node: Node) {
...
function xmlToTimeModification(node: Node) {
...
function xmlToNotehead(node: Node) {
...
function xmlToNotations(node: Node) {
...
function xmlToTuplet(node: Node) {
    let ret: Tuplet = <any> {};
    let foundBracket = false;
...
function xmlToTupletActual(node: Node) {
...
function xmlToTupletNormal(node: Node) {
...
function xmlToTupletNumber(node: Node) {
...
function xmlToTupletType(node: Node) {
...
function xmlToGlissando(node: Node) {
    ...
    for (let i = 0; i < node.attributes.length; ++i) {
        ...
        if (ch2.name === "normal") {
            let dataNormal = getNumber(ch2, true);
...
function xmlToOtherNotation(node: Node) {
...
function xmlToOtherDirection(node: Node) {
...
function xmlToOrnaments(node: Node) {
...
function xmlToDelayedTurn(node: Node) {
...
function xmlToInvertedTurn(node: Node) {
...
function xmlToDelayedInvertedTurn(node: Node) {
...
function xmlToMordent(node: Node) {
    let ret: Mordent = <any> {};
    let foundFontWeight = false;
    let foundFontStyle = false;
    let foundColor = false;
...
function xmlToInvertedMordent(node: Node) {
...
function xmlToTremolo(node: Node) {
    let ret: Tremolo = <any> {};
    let foundFontWeight = false;
    let foundFontStyle = false;
    let foundColor = false;
...
function xmlToOtherOrnament(node: Node) {
...
function xmlToAccidentalMark(node: Node) {
...
function xmlToTechnical(node: Node) {
...
function xmlToHarmonic(node: Node) {
...
function xmlToHammerOn(node: Node) {
...
function xmlToPullOff(node: Node) {
    let ret: PullOff = <any> {};
    let foundNumber_ = false;
    let foundFontWeight = false;
    let foundFontStyle = false;
...
function xmlToWithBar(node: Node) {
    let ret: WithBar = <any> {};
    let foundFontWeight = false;
    let foundFontStyle = false;
    let foundColor = false;
...
function xmlToHoleClosed(node: Node) {
...
function xmlToHandbell(node: Node) {
...
function xmlToOtherTechnical(node: Node) {
...
function xmlToArticulations(node: Node) {
...
function xmlToStrongAccent(node: Node) {
...
function xmlToBreathMark(node: Node) {
...
function xmlToOtherArticulation(node: Node) {
...
function xmlToArpeggiate(node: Node) {
...
function xmlToNonArpeggiate(node: Node) {
...
function xmlToFiguredBass(node: Node) {
...
function xmlToFigure(node: Node) {
    let ret: Figure = <any> {};
    let foundFontWeight = false;
    let foundFontStyle = false;
    let foundColor = false;
...
function xmlToPrefix(node: Node) {
    let ret: Prefix = <any> {};
    let foundFontWeight = false;
    let foundFontStyle = false;
    let foundColor = false;
...
function xmlToFigureNumber(node: Node) {
...
function xmlToSuffix(node: Node) {
    let ret: Suffix = <any> {};
    let foundFontWeight = false;
    let foundFontStyle = false;
    let foundColor = false;
...
function xmlToBackup(node: Node) {
    let ret: Backup = <any> {};
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
        if (ch.nodeName === "footnote") {
...
function xmlToForward(node: Node) {
    let ret: Forward = <any> {};
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
        if (ch.nodeName === "voice") {
...
function xmlToBarline(node: Node) {
    let ret: Barline = <any> {};
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
...
function xmlToBarStyle(node: Node) {
...
function getStartStopDiscontinue(node: Node, fallbackVal?: StartStopDiscontinue) {
    "use strict"
    let s = (node.nodeType === node.ATTRIBUTE_NODE ? (<Attr>node).value : node.textContent).trim();
    if (s === "" && fallbackVal !== null && fallbackVal !== undefined) {
        return fallbackVal;
...
function xmlToEnding(node: Node) {
    let ret: Ending = <any> {};
    let foundPrintObject = false;
    let foundFontWeight = false;
    let foundFontStyle = false;
...
function xmlToRepeat(node: Node) {
    let ret: Repeat = <any> {};
...
function xmlToDirection(node: Node) {
...
function xmlToRehearsal(node: Node) {
...
function xmlToDashes(node: Node) {
    let ret: Dashes = <any> {};
    let foundNumber_ = false;
    let foundDashLength = false;
    let foundSpaceLength = false;
...
function xmlToBracket(node: Node) {
    let ret: Bracket = <any> {};
    let foundNumber_ = false;
    let foundLineType = false;
    let foundDashLength = false;
...
function xmlToMetronome(node: Node) {
...
function xmlToPerMinute(node: Node) {
...
function xmlToMetronomeNote(node: Node) {
...
function xmlToMetronomeBeam(node: Node) {
...
function xmlToMetronomeTuplet(node: Node) {
...
function xmlToOctaveShift(node: Node) {
...
function xmlToHarpPedals(node: Node) {
...
function xmlToPedalTuning(node: Node) {
...
function xmlToStringMute(node: Node) {
...
function xmlToScordatura(node: Node) {
...
function xmlToAccord(node: Node) {
    let ret: Accord = <any> {};
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
        if (ch.nodeName === "tuning-alter") {
...
function xmlToPrincipalVoice(node: Node) {
...
function xmlToAccordionRegistration(node: Node) {
...
function xmlToPercussion(node: Node) {
...
function xmlToBeater(node: Node) {
    let ret: Beater = <any> {};
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
    }
...
function xmlToOffset(node: Node) {
    let ret: Offset = <any> {};
...
function getExplicitImpliedAlternate(node: Node, fallbackVal?: ExplicitImpliedAlternate) {
    "use strict"
    let s = (node.nodeType === node.ATTRIBUTE_NODE ? (<Attr>node).value : node.textContent).trim();
    if (s === "" && fallbackVal !== null && fallbackVal !== undefined) {
        return fallbackVal;
...
function xmlToRootStep(node: Node) {
...
function xmlToRootAlter(node: Node) {
...
function xmlToFunction(node: Node) {
...
function xmlToInversion(node: Node) {
...
function xmlToBassStep(node: Node) {
...
function xmlToBassAlter(node: Node) {
...
function xmlToDegree(node: Node) {
    let ret: Degree = <any> {};
    let foundPrintObject = false;
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
...
function xmlToDegreeValue(node: Node) {
...
function xmlToDegreeAlter(node: Node) {
...
function xmlToDegreeType(node: Node) {
...
function xmlToFirstFret(node: Node) {
...
function xmlToFrameNote(node: Node) {
...
function xmlToFeature(node: Node) {
    let ret: Feature = <any> {};
    for (let i = 0; i < node.childNodes.length; ++i) {
        let ch = node.childNodes[i];
    }
...
function xmlToMeasureNumbering(node: Node) {
...
function xmlToDefaults(node: Node) {
...
function xmlToLyricFont(node: Node) {
...
function xmlToLyricLanguage(node: Node) {
...
function xmlToCreditWords(node: Node) {
...
function xmlToCreditImage(node: Node) {
...
function xmlToPartName(node: Node) {
    let ret: PartName = {
        partName: "",
        defaultX: null,
        defaultY: null,
...
function xmlToPartAbbreviation(node: Node) {
...
function xmlToGroupName(node: Node) {
...
function xmlToGroupAbbreviation(node: Node) {
...
function xmlToGroupSymbol(node: Node) {
...
function xmlToGroupBarline(node: Node) {
...
function xmlToScoreInstrument(node: Node) {
...
function xmlToVirtualInstrument(node: Node) {
...
function xmlToScoreHeader(node: Node) {
 ...
 */
function xml(literals: string[], ...vals: (number | string)[]): string {
    let escaped = "";
 ...
 */
function yesNo(literals: string[], ...booleans: any[]): string {
    let escaped = "";
    for (let i = 0; i < literals.length; ++i) {
        escaped += literals[i];
 ...
 */
function dangerous(literals: string[], ...vals: string[]): string {
    let result = "";
    for (let i = 0; i < literals.length; ++i) {
        result += literals[i];
        if (i < vals.length) {
...
function hmarginsToXML(hmargins: {leftMargin: number; rightMargin: number}): string[] {
...
function vmarginsToXML(hmargins: {topMargin: number; bottomMargin: number}): string[] {
...
function systemDividersToXML(systemDividers: SystemDividers): string {
    ...
    if (defined(systemDividers.leftDivider)) {
        children.push(xml `<left-divider${
    ...
    if (defined(systemDividers.rightDivider)) {
        children.push(xml `<right-divider${
...
function noteSizeToXML(noteSize: NoteSize): string {
    ...
    // >
    return xml `<note-size type="${
        cueGraceLargeToXML[noteSize.type]}">${noteSize.size}</note-size>`;
}
...
function encodingDateToXML(encodingDate: EncodingDate): string {
    ...
    return xml `<encoding-date>${
        ("0000" + encodingDate.year).slice(-4)}-${
        ("00" + encodingDate.month).slice(-2)}-${
        ("00" + encodingDate.day).slice(-2)}</encoding-date>`;
}
...
function miscellaneousFieldToXML(field: MiscellaneousField): string {
    ...
    return xml `<miscellaneous-field name="${field.name}">${
        field.data || ""}</miscellaneous-field>`;
}
...
function lyricLanguageToXML(lyricLanguage: LyricLanguage): string {
    ...
    return dangerous `<lyric-language${
        numberLevelToXML(lyricLanguage) +
...
function partNameDisplayToXML(partNameDisplay: PartNameDisplay): string {
    ...
    //     %print-object;
    // >
    return dangerous `<part-name-display${
        printObjectToXML(partNameDisplay)}>\n${
            textArrayToXML(partNameDisplay.name).join("\n")
            .split("\n").map(n => "  " + n).join("\n")}</part-name-display>`;
}
...
function partAbbreviationDisplayToXML(partAbbreviationDisplay:
    ...
    //     %print-object;
    // >
    return dangerous `<part-abbreviation-display${
        printObjectToXML(partAbbreviationDisplay)}>${
            textArrayToXML(partAbbreviationDisplay.name).join("\n")
...
function groupNameToXML(groupName: GroupName): string {
    ...
    return dangerous `<group-name${
        printStyleToXML(groupName) +
        justifyToXML(groupName)}>${pcdata}</group-name>`;
}
...
function groupAbbreviationToXML(groupAbbreviation: GroupAbbreviation): string {
    ...
    return dangerous `<group-abbreviation${
        printStyleToXML(groupAbbreviation) +
        justifyToXML(groupAbbreviation)}>${pcdata}</group-abbreviation>`;
}

function groupAbbreviationDisplayToXML(groupAbbreviationDisplay:
        GroupAbbreviationDisplay): string {
...
function groupSymbolToXML(groupSymbol: GroupSymbol): string {
    ...
    return dangerous `<group-symbol${
        positionToXML(groupSymbol) +
        colorToXML(groupSymbol)}>${pcdata}</group-symbol>`;
}
...
function groupBarlineToXML(groupBarline: GroupBarline): string {
    ...
    return dangerous `<group-barline${
...
function frameToXML(frame: Frame): string {
    ...
    (frame.frameNotes || []).forEach(frameNote => {
        ...
        if (defined(frameNote.string)) {
            ...
            fChildren.push(dangerous `<string${
                    printStyleToXML(frameNote.string) +
                    placementToXML(frameNote.string)}>${pcdata}</string>`);
        }
        // <!ELEMENT fret (#PCDATA)>
        // <!ATTLIST fret
        //     %font;
        ...
        if (defined(frameNote.fret)) {
            ...
            fChildren.push(dangerous `<fret${
                    fontToXML(frameNote.fret) +
                    colorToXML(frameNote.fret)}>${pcdata}</fret>`);
        }
        ...
        if (defined(frameNote.barre)) {
            fChildren.push(dangerous `<barre${
                    startStopToXML(frameNote.barre) +
...
function noteToXML(note: Note) {
    ...
    */
    ...
    if (note.accidental) {
        ...
        elements.push(dangerous `<accidental${accidentalAttribs}>${accidentalToXML[
            note.accidental.accidental]}</accidental>`); // (safe)
    }
    ...
    if (note.timeModification) {
        ...
        if (note.timeModification.actualNotes) {
            timeModificationChildren.push(xml `<actual-notes>${
                    note.timeModification.actualNotes}</actual-notes>`);
        }
        if (note.timeModification.normalNotes) {
            timeModificationChildren.push(xml `<normal-notes>${
                    note.timeModification.normalNotes}</normal-notes>`);
        }
    ...
    if (note.notehead) {
        ...
        elements.push(dangerous `<notehead${hattribs}>${
                noteheadTypeToXML[note.notehead.type]}</notehead>`);
    }
    ...
    (note.notations || []).forEach(notation => {
        ...
        (notation.tuplets || []).forEach(tuplet => {
            ...
            [["tuplet-actual", "tupletActual"], ["tuplet-normal", "tupletNormal"]].forEach(tup => {
                ...
                if (data.tupletNumber) {
                    ...
                    dataChildren.push(dangerous `<tuplet-number${
                        fontToXML(num) + colorToXML(num)}>${pcdata}</tuplet-number>`);
                }
                if (data.tupletType) {
        ...
        (notation.glissandos || []).forEach(glissando => {
            ...
            nChildren.push(dangerous `<glissando${
        ...
        (notation.slides || []).forEach(slide => {
            ...
            nChildren.push(dangerous `<slide${
        ...
        (notation.ornaments || []).forEach(ornaments => {
            ...
            if (ornaments.tremolo) {
                ...
                oChildren.push(dangerous `<tremolo${
        ...
        (notation.technicals || []).forEach(technical => {
            ...
            // >
            if (technical.upBow) {
                oChildren.push(dangerous `<up-bow${
                    printStyleToXML(technical.upBow) +
            ...
            if (technical.downBow) {
                oChildren.push(dangerous `<down-bow${
            ...
            if (technical.harmonic) {
                ...
                oChildren.push(dangerous `<harmonic${
            ...
            if (technical.openString) {
                oChildren.push(dangerous `<open-string${
            ...
            if (technical.thumbPosition) {
                oChildren.push(dangerous `<thumb-position${
            ...
            // >
            if (technical.pluck) {
                oChildren.push(dangerous `<pluck${
                    printStyleToXML(technical.pluck) +
            ...
            if (technical.doubleTongue) {
                oChildren.push(dangerous `<double-tongue${
            ...
            if (technical.tripleTongue) {
                oChildren.push(dangerous `<triple-tongue${
            ...
            if (technical.stopped) {
                oChildren.push(dangerous `<stopped${
            ...
            if (technical.snapPizzicato) {
                oChildren.push(dangerous `<snap-pizzicato${
            ...
            if (technical.hammerOn) {
                ...
                oChildren.push(dangerous `<hammer-on${
            ...
            if (technical.pullOff) {
                ...
                oChildren.push(dangerous `<pull-off${
            ...
            if (technical.bend) {
                ...
                if (defined(technical.bend.withBar)) {
                    ...
                    bendChildren.push(dangerous `<with-bar${
            ...
            if (technical.tap) {
                ...
                oChildren.push(dangerous `<tap${
                    printStyleToXML(technical.tap) +
                    placementToXML(technical.tap)
                }>${pcdata}</tap>`);
            }
            // 
            // <!ATTLIST heel
            ...
            if (technical.fingernails) {
                oChildren.push(dangerous `<fingernails${
            ...
            if (technical.hole) {
                ...
                if (defined(technical.hole.holeClosed)) {
                    ...
                    holeChildren.push(dangerous `<hole-closed${holeClosedAttribs}>${
                        holeClosedTypeToXML[technical.hole.holeClosed.data]}</hole-closed>`);
                }
                if (defined(technical.hole.holeShape)) {
                    holeChildren.push(xml `<hole-shape>${technical.hole.holeShape}</hole-shape>`);
                }
                oChildren.push(dangerous `<hole${
                            printStyleToXML(technical.hole) +
                            placementToXML(technical.hole)
                        }>${holeChildren.join("\n").split("\n")
                    .map(n => "  " + n).join("\n")}\n</hole>`);
            }
            // 
            ...
            if (technical.arrow) {
                ...
                oChildren.push(dangerous `<arrow${
                            printStyleToXML(technical.arrow) +
                            placementToXML(technical.arrow)
                        }>${arrowChildren.join("\n").split("\n")
                    .map(n => "  " + n).join("\n")}\n</arrow>`);
            }
            // 
            ...
            if (technical.handbell) {
                ...
                oChildren.push(dangerous `<handbell${
            ...
            if (technical.otherTechnical) {
                ...
                oChildren.push(dangerous `<other-technical${
        ...
        (notation.articulations || []).forEach(articulation => {
            ...
            if (articulation.accent) {
                oChildren.push(dangerous `<accent${
            ...
            if (articulation.strongAccent) {
                oChildren.push(dangerous `<strong-accent${
            ...
            if (articulation.staccato) {
                oChildren.push(dangerous `<staccato${
            ...
            if (articulation.tenuto) {
                oChildren.push(dangerous `<tenuto${
            ...
            if (articulation.staccatissimo) {
                oChildren.push(dangerous `<staccatissimo${
            ...
            if (articulation.spiccato) {
                oChildren.push(dangerous `<spiccato${
            ...
            if (articulation.scoop) {
                oChildren.push(dangerous `<scoop${
            ...
            if (articulation.falloff) {
                oChildren.push(dangerous `<falloff${
            ...
            if (articulation.breathMark) {
                ...
                oChildren.push(dangerous `<breath-mark${
            ...
            if (articulation.caesura) {
                oChildren.push(dangerous `<caesura${
            ...
            if (articulation.stress) {
                oChildren.push(dangerous `<stress${
            ...
            if (articulation.unstress) {
                oChildren.push(dangerous `<unstress${
        ...
        (notation.arpeggiates || []).forEach(arpeggiate => {
            ...
            //     %color;
            // >
            nChildren.push(dangerous `<arpeggiate${
        ...
        (notation.nonArpeggiates || []).forEach(nonArpeggiate => {
            ...
            //     %color;
            // >
            nChildren.push(dangerous `<non-arpeggiate${
        ...
        (notation.accidentalMarks || []).forEach(accidentalMark => {
            ...
            // >
            let pcdata = xml `${accidentalMark.mark}`;
            nChildren.push(dangerous `<accidental-mark${
                printStyleToXML(accidentalMark) +
                placementToXML(accidentalMark)
        ...
        (notation.otherNotations || []).forEach(otherNotation => {
            ...
            nChildren.push(dangerous `<other-notation${
        ...
        (lyric.lyricParts || []).forEach(part => {
            ...
            switch(part._class) {
                case "Syllabic":
                    ...
                    lyricChildren.push(dangerous `<syllabic>${
                        syllabicTypeToXML[part.data]}</syllabic>`);
                    break;
                case "Text":
                    // <!ELEMENT text (#PCDATA)>
                    // <!ATTLIST text
                    ...
                    lyricChildren.push(dangerous `<text${
                        fontToXML(part) +
                        colorToXML(part) +
                ...
                case "Elision":
                    ...
                    lyricChildren.push(dangerous `<elision${
                        startStopContinueToXML(part) +
                ...
                case "Extend":
                    ...
                    //     %print-style;
                    // >
                    lyricChildren.push(dangerous `<extend${
                        startStopContinueToXML(part) +
                        printStyleToXML(part)
                    } />`);
                    break;
...
function wedgeToXML(wedge: Wedge): string {
    ...
    // >
    let attribs = "" +
        xml ` type="${wedgeTypeToXML[wedge.type]}"` +
...
function pedalToXML(pedal: Pedal): string {
    ...
    // >
    let attribs = "" +
            xml ` type="${pedalTypeToXML[pedal.type]}"`;
...
function metronomeToXML(metronome: Metronome): string {
    ...
    (metronome.metronomeNotes || []).forEach(note => {
        ...
        (note.metronomeBeams || []).forEach(beam => {
            ...
            oChildren.push(dangerous `<metronome-beam${numberLevelToXML(beam)}>${
...
function metronomeTupletToXML(metronomeTuplet: MetronomeTuplet): string {
    ...
    if (metronomeTuplet.actualNotes) {
        children.push(xml `<actual-notes>${
                metronomeTuplet.actualNotes}</actual-notes>`);
    }
    if (metronomeTuplet.normalNotes) {
        children.push(xml `<normal-notes>${
                metronomeTuplet.normalNotes}</normal-notes>`);
    }
...
function accordionRegistrationToXML(accordionRegistration: AccordionRegistration): string {
...
function otherDirectionToXML(otherDirection: OtherDirection): string {
    ...
    return dangerous `<other-direction${
            printObjectToXML(otherDirection) +
            printStyleAlignToXML(otherDirection)}>${pcdata}</other-direction>`;
}
...
function fermataToXML(fermata: Fermata): string {
    ...
    //     %print-style;
    // >
    let pcdata = defined(fermata.shape) ? normalAngledSquareToXML[fermata.shape] : "";
    let attribs = defined(fermata.type) ? xml ` type="${
            uprightInvertedToXML[fermata.type]}"` : "";
...
function tuningStepAlterOctaveToXML(tuning: {tuningAlter?: string; tuningStep?: string; tuningOctave: string}): string[] {
    let children: string[] = [];
...
function startStopToXML(startStop: {type: StartStop}): string {
    ...
    if (defined(startStop.type)) {
        return xml ` type="${startStop.type === StartStop.Start ?
            "start" : "stop"}"`;
    }
    return "";
}

function startStopDiscontinueToXML(startStop: {type: StartStopDiscontinue}): string {
    // <!ENTITY % start-stop "(start | stop)">
...
function startStopContinueToXML(startStopContinue:
    ...
    if (defined(startStopContinue.type)) {
        return xml ` type="${startStopContinueSingleToXML[
...
function placementToXML(placement: Placement): string {
    ...
    if (placement.placement > AboveBelow.Unspecified) {
        return xml ` placement="${placement.placement === AboveBelow.Above ?
            "above" : "below"}"`;
    }
    return "";
}
...
function orientationToXML(orientation: Orientation): string {
    ...
    if (orientation.orientation > OverUnder.Unspecified) {
        return xml ` orientation="${orientation.orientation === OverUnder.Over ?
            "over" : "under"}"`;
    }
    return "";
}
...
function fontToXML(font: Font): string {
    ...
    if (defined(font.fontStyle)) {
        attribs += xml ` font-style="${font.fontStyle ===
    ...
    if (defined(font.fontWeight)) {
        attribs += xml ` font-weight="${font.fontWeight ===
...
function valignToXML(valign: Valign): string {
    if (defined(valign.valign)) {
        return xml ` valign="${
            topMiddleBottomBaselineToXML[valign.valign]}"`;
    }
    return "";
}
...
function mordentSubsetToXML(mordent: Mordent): string {
    ...
    if (defined(mordent.approach)) {
        attribs += xml ` approach="${mordent.approach === AboveBelow.Above ?
            "above" : "below"}"`;
    }

    if (defined(mordent.departure)) {
        attribs += xml ` departure="${mordent.departure === AboveBelow.Above ?
            "above" : "below"}"`;
    }
